...
type abstract_syntax_tree = ExpList of expr list
...
and func_decl = {ret_type: scrawl_type; ident: string; params: qual_ident list; pos: pos}
and bin_op = 
...
(*TODO 0: Helper functions if needed for building the abstract syntax tree *)
